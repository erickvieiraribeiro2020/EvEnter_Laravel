...
<header>
        ...
        <div class="botoes">
            ...
            <div class="dropdown" style="background-color:  rgb(0, 0, 0);">
                <a class="btn btn-secondary dropdown-toggle" href="#"
                    style="background-color: rgb(, 0, 0); border: none; color: #ff9a04" role="button"
    ...
    <div class="trending">
        <table class="table">
            <tbody>
                <tr>
                    <td class="name"><a href="<?php echo e(route('event')); ?>">Festa das cores</a></td>
                    <td class="desc"><a href="<?php echo e(route('event')); ?>">Festa</a></td>
                    <td class="end"><a class="next" href="<?php echo e(route('event')); ?>">></a></td>
                </tr>
            </tbody>
        </table>
    </div>
...
</body><?php /**PATH C:\Users\Erick\projeto2\resources\views/welcome.blade.php ENDPATH**/ ?>