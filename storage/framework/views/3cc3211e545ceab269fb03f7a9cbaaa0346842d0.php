...
<head>
    ...
    <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js"
        ...
        crossorigin="anonymous"></script>
    <title>Evento</title>
    <link rel="stylesheet" href="<?php echo e(asset('/css/Visualização_do_Evento.css')); ?>">
</head>
    ...
    <div class="box">
        <form>
            <div class="form-group">
                <a href="<?php echo e(route('home')); ?>" class="back">
...
</html><?php /**PATH C:\Users\Erick\projeto2\resources\views/eventos.blade.php ENDPATH**/ ?>